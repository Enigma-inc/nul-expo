                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <div class="form-group label-floating padding-right-10 {{ $errors->has('chair_country') ? ' has-error' : ''}}">
                            ...
                            <div class="country-flex">
                                ...
                                <input required class="country-flag-flex" id="chair_country" type="text" class="form-control" name="chair_country" value="{{$rerisEventObject->chair_country}}" data-provide="typeahead">
                        ...
                        <div class="form-group label-floating padding-right-10 {{ $errors->has('presenter_country') ? ' has-error' : ''}}">
                                ...
                                <div class="country-flex">
                                        ...
                                        <input required class="country-flag-flex" id="presenter_country" type="text" class="form-control" name="presenter_country" value="{{$rerisEventObject->presenter_country}}" data-provide="">
