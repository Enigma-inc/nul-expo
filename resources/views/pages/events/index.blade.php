        ...
        <div class="row clearfix">
            <div class="stall-card">
                ...
                <div class="stall-card-right">
                    ...
                    <h5 class="stall-card-subtitle">
                        <i class="fa fa-building" style="color: #e13f30 !important;margin-right: 5px;"
                            aria-hidden="true"></i>
                        Venue: Pioneer Mall ground and first floor corridors
                    </h5>
                    <p style="text-align: justify;">
                        The stalls will display tangible innovative products by NUL lecturers, students, graduates, and
                        interested businesses from outside the NUL. Please note that only businesses that do value
                        addition are accepted. We don't take businesses that buy and sell. <br>
                        Submission: Please submit an introduction of your business or product (just a sentence). Put in
                        your full contact details including email and cell phone (preferaly whatsapp).
                    </p>
                    <h5 class="stall-card-subtitle">
                        <i class="fa fa-clock" style="color: #e13f30 !important;margin-right: 5px;"
                            aria-hidden="true"></i>
                        Deadline: 15th of January 2020
                    </h5>
                    <p style="font-style: italic;">
                        Buy a stall electronically <a
                            href="https://app.ticketbox.co.ls/e/3/nulistice-2020-expo-gala-dinner"
                            target="_blank">here</a> or put it into the following <a href="#" data-toggle="modal"
                            data-target="#exampleModal">NUL account</a> (Send a proof of payment to:
                        ketsi.motlatsi@gmail.com).
                    </p>
                    <p style="font-style: italic;">
            ...
            <div class="stall-card">
                ...
                <div class="stall-card-right">
                    ...
                    <p style="text-align: justify;">
                        The Conference will be in the form of a Science, Technology and Innovation Forum at the Gala
                        Dinner. The Gala will be a time to enjoy and reflect on the journey of innovation.
                    </p>
                    <p style="font-style: italic;">
                        Contact: ketsi.motlatsi@gmail.com or call +266 53256707 for more information.
                    </p>
            ...
            <div class="stall-card">
                ...
                <div class="stall-card-right">
                    ...
                    <p style="text-align: justify;">
                        This will be a 24 hour coding marathon (hackathon) where computer gurus and thinkers from other
                        disciplines in Lesotho and South Africa's higher education institutions will battle it out,
                        solving the most interesting problems of our time. Students and graduates from NUL, LIMKOKWING,
                        LEROTHOLI, BOTHO etc, and South Africa Universities are invited to apply. <br>
                        Competing teams must have a maximum of 5 competitors and a minimum of 1 competitor. Each team
                        must have at least one person with a knowledge of coding. Awards will be given to winners.
                    </p>
                    <h5 class="stall-card-subtitle">
                        <i class="fa fa-clock" style="color: #e13f30 !important;margin-right: 5px;"
                            aria-hidden="true"></i>
