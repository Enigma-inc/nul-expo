        ...
        <div class="counter-section">
            <div class="row clearfix">
                ...
                <div class="col-md-4 col-sm-12 col-xs-12 text-right">
                    <a href="booking" class="theme-btn btn-style-one hvr-bounce-to-right"><span class="fa fa-play"></span> BOOK YOUR SPACE</a>
                </div>
            </div>
        </div>
            ...
            <div class="col-xs-12 text-column wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                <div class="col-xs-12 col-sm-8">
                    <div class="sec-title wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                        <h2>Welcome to NUL Expo 2017</h2>
                    </div>
                    <div class="text welcome">
                       ...
                       The National University of Lesotho (NUL) is located at about 34 km from Maseru, the Capital city of the Kingdom of Lesotho. The origin of the university dates back to 8th April, 1945 when a Catholic University College, the Pius XII College, was founded at Roma by the Roman Catholic Hierarchy of Southern Africa. Since 1945, various major developments in the history of the University have taken place both in terms of physical infrastructure development and growth in students' enrolment. 
                        ...
                        <p style="text-align: justify;">
                            This 2018 National University of Lesotho International Science and Technology Innovation Conference & Expo (NULSTICE-2018) is meant to provide an opportunity to turn ideas into action. It is expected that the attending scholars from all over the world will share their basic research findings, lessons in university-industry cooperation, successes and failures in commercialization and policy recommendations in any of the areas mentioned above. NULSTICE-2018 and the parallel events combined together are going to be bigger in scope and wider in reach. While the previous events were just one day expos and workshops, this 2018 event will combine together an International Conference & Expo, student’s competitions (proposed Vodacom-NUL Hackathon), Gala Dinner and a Daytrip for the international visitors. 
                        </p>
                        ...
                        <p style="text-align: justify;">
                            Lesotho (The Forgotten Kingdom, as one movie maker would define it) is so small a country; many people around the world just haven’t heard anything about it. The fact that it is “hidden” within South Africa, and completely surrounded by it, does not help either. The result is a country with so many good things that is almost unknown to the outside world.
                        </p>
