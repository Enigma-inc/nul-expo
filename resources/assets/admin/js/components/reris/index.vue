      ...
      <div class="active-events col-xs-12" v-for="event in activeEvents" :key="event.id">
        <div class="event-field">
          ...
          <div class="event-field">
              ...
              <div class="details">
                   <toggle-event-status :toggle-text="'Deactivate'" :type="'reris'" :event="event"> </toggle-event-status>
              </div>
          </div>
      </div>
   <vue-good-table
                ...
                <template slot="table-row-after" scope="props">
                    <td>
                       <toggle-event-status :toggle-text="'Activate'" :type="'reris'" :event="props.row"> </toggle-event-status>
                    </td>
                </template>
    </vue-good-table>
  </div>
