...
Route::get('events/reris','RerisEventController@index');
 ...
 //Live 
 Route::get('/events/nulistice/{status}','NulisticeEventController@index');
 Route::get('/events/reris/{status}','RerisEventController@index');
 Route::get('/events/general/{status}','GeneralEventController@index');
 
 //Gallery
 Route::get('/events/gallery/images/{count}', 'ImageGalleryController@index');
